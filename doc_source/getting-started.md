...
![\[Hello world.\]](http://docs.aws.amazon.com/step-functions/latest/dg/images/tutorial-create-state-machine-hello-world.png)![\[Hello world.\]](http://docs.aws.amazon.com/step-functions/latest/dg/)![\[Hello world.\]](http://docs.aws.amazon.com/step-functions/latest/dg/)
...
![\[Visual Workflow.\]](http://docs.aws.amazon.com/step-functions/latest/dg/images/hello-state-machine-preview.png)![\[Visual Workflow.\]](http://docs.aws.amazon.com/step-functions/latest/dg/)![\[Visual Workflow.\]](http://docs.aws.amazon.com/step-functions/latest/dg/)
...
![\[State machine results.\]](http://docs.aws.amazon.com/step-functions/latest/dg/images/tutorial-console-state-machine-execution-output.png)![\[State machine results.\]](http://docs.aws.amazon.com/step-functions/latest/dg/)![\[State machine results.\]](http://docs.aws.amazon.com/step-functions/latest/dg/)
...
![\[Image NOT FOUND\]](http://docs.aws.amazon.com/step-functions/latest/dg/images/tutorial-console-state-machine-updated.png)![\[Image NOT FOUND\]](http://docs.aws.amazon.com/step-functions/latest/dg/)![\[Image NOT FOUND\]](http://docs.aws.amazon.com/step-functions/latest/dg/)

1. Choose **Start Execution**\.

1. To view the results of your execution, choose the **Output** tab in the **Execution Details** section\.  
![\[Start new execution.\]](http://docs.aws.amazon.com/step-functions/latest/dg/images/tutorial-console-state-machine-update-output.png)![\[Start new execution.\]](http://docs.aws.amazon.com/step-functions/latest/dg/)![\[Start new execution.\]](http://docs.aws.amazon.com/step-functions/latest/dg/)
**Note**  
