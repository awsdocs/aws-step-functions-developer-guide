...
+ [How Step Functions works](how-step-functions-works.md)
   ...
   + [Executions in Step Functions](concepts-state-machine-executions.md)
      ...
      + [Viewing and debugging executions on the Step Functions console](concepts-sm-exec-details-ui.md)
         + [Execution Details page – Interface overview](exec-details-interface-overview.md)
         + [Tutorial: Examining state machine executions using the Step Functions console](debug-sm-exec-using-ui.md)
