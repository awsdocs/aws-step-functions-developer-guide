...
Step Functions uses IAM to control access to other AWS services and resources\. For an overview of how IAM works, see [Overview of Access Management](http://docs.aws.amazon.com/IAM/latest/UserGuide/introduction_access-management.html) in the *IAM User Guide*\. For an overview of security credentials, see [AWS Security Credentials](http://docs.aws.amazon.com/general/latest/gr/aws-security-credentials.html) in the Amazon Web Services General Reference\.
